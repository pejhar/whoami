...
function executeCommand(command) {
    switch (command) {
        ...
        case "aboutMe":
            ...
            aboutMe.innerHTML =
            `
            <span class="about-txt">Hello visitor,<br> My name is Ahmad. I am a web developer who is fairly new at this,<br>
            ...
            You can check my CV here: <a href="https://www.linkedin.com/in/ahmad-shirzadi/" target="_blank">https://www.linkedin.com/in/ahmad-shirzadi/</a>.<br>
            You can also check my GitHub page here: <a href="https://github.com/pejhar" target="_blank">https://github.com/pejhar</a><br>
              </div>
            `
